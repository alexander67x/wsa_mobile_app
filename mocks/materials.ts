...
export const materialCatalog: CatalogItem[] = [
  { id: '1', name: 'Cámara IP 4MP', unit: 'unidades' },
  { id: '2', name: 'NVR 16 canales', unit: 'unidades' },
  { id: '3', name: 'Sensor PIR interior', unit: 'unidades' },
  { id: '4', name: 'Sensor magnético de puerta', unit: 'unidades' },
  { id: '5', name: 'Switch PoE 8 puertos', unit: 'unidades' },
  { id: '6', name: 'Cable UTP Cat6', unit: 'metros' },
  { id: '7', name: 'Tubos corrugados 3/4"', unit: 'metros' },
  { id: '8', name: 'Fuente 12V 5A', unit: 'unidades' },
  { id: '9', name: 'Sirena exterior', unit: 'unidades' },
  { id: '10', name: 'Conector RJ45', unit: 'unidades' },
];
